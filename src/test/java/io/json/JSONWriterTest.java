...
public class JSONWriterTest {
    ...
    public void testJSONWriter() {
        ...
        try {
            GONWriter writer = GONWriter.PRETTY_JSON;
            ...
            writer.write(map,new FileOutputStream("test_run_dir/json_parser_write.json"));
            TesterCore.parser_write_test_file(vsonParser.mappify(new FileInputStream("test_run_dir/json_parser_write.json")));
